...
HYKU_METADATA_RENDERING_ATTRIBUTES = {
  ...
  technique: { render_as: :faceted, html_dl: true },
  material: { render_as: :faceted, html_dl: true },
  measurement: { html_dl: true },
  cultural_context: { html_dl: true },
  mesh: { html_dl: true },
  tab_heading: { html_dl: true },
  keyword: { render_as: :faceted, html_dl: true },
  people_represented: { render_as: :faceted, html_dl: true, label: "People" },
  ...
  resource_query: { render_as: :faceted, html_dl: true },
